...
export const i18n = new VueI18n({
  ...
  messages: {
    en: {
      ...
      settings_summary_method: 'Summarization Method',
      settings_microphone_mode: 'Microphone Mode',
      name: 'Name',
      email: 'E-Mail',
      avatar: 'Avatar',
      point: 'Point',
    ...
    de: {
      ...
      stop: 'Stop',
      close: 'Schließen',
      exporter_summary: 'Zusammenfassung',
      ...
      settings_summary_method: 'Methode für generierte Zusammenfassungen',
      settings_microphone_mode: 'Mikrophon Modus',
      name: 'Name',
      email: 'E-Mail',
      avatar: 'Avatar',
      point: 'Punkt',
